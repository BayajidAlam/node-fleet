...
export const masterSg = new aws.ec2.SecurityGroup("master-sg", {
    ...
    ingress: [
        ...
        // K3s API server
        { protocol: "tcp", fromPort: 6443, toPort: 6443, cidrBlocks: ["10.0.0.0/16"], description: "K3s API" },
        // Prometheus NodePort
        { protocol: "tcp", fromPort: 30090, toPort: 30090, cidrBlocks: ["0.0.0.0/0"], description: "Prometheus" },
        // Grafana NodePort
        { protocol: "tcp", fromPort: 3000, toPort: 3000, cidrBlocks: ["0.0.0.0/0"], description: "Grafana" },
        // Demo app NodePort
        { protocol: "tcp", fromPort: 30080, toPort: 30080, cidrBlocks: ["0.0.0.0/0"], description: "Demo App" },
        // Flannel VXLAN (K3s networking)
        { protocol: "udp", fromPort: 8472, toPort: 8472, cidrBlocks: ["10.0.0.0/16"], description: "Flannel VXLAN" },
        // Kubelet
        { protocol: "tcp", fromPort: 10250, toPort: 10250, cidrBlocks: ["10.0.0.0/16"], description: "Kubelet" }
    ],
    egress: [
...
export const workerSg = new aws.ec2.SecurityGroup("worker-sg", {
    ...
    ingress: [
        ...
        { protocol: "tcp", fromPort: 30000, toPort: 32767, cidrBlocks: ["10.0.0.0/16"], description: "NodePort services" }
    ],
    egress: [
        { protocol: "-1", fromPort: 0, toPort: 0, cidrBlocks: ["0.0.0.0/0"], description: "Allow all outbound" }
    ],
